...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SSC006_ROUTE {0b0001} \
   CONFIG.SSC007_ROUTE {0b0100} \
   CONFIG.SSC008_ROUTE {0b1000} \
   CONFIG.SSC009_ROUTE {0b0000} \
   CONFIG.SSC010_ROUTE {0b0000} \
   CONFIG.SSC011_ROUTE {0b0000} \
   CONFIG.SSC012_ROUTE {0b0000} \
   CONFIG.SSC013_ROUTE {0b0000} \
   CONFIG.SSC014_ROUTE {0b0000} \
   CONFIG.SSC015_ROUTE {0b0000} \
...
proc create_hier_cell_clk_map { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net clk_map_aclk1_net [get_bd_pins M00_ACLK] [get_bd_pins S00_ACLK] [get_bd_pins S02_ACLK] [get_bd_pins S03_ACLK] [get_bd_pins aclk1] [get_bd_pins psr0/slowest_sync_clk] [get_bd_pins psr_aclk1/slowest_sync_clk]
  ...
  connect_bd_net -net psr_aclk1_interconnect_aresetn [get_bd_pins M00_ARESETN] [get_bd_pins S00_ARESETN] [get_bd_pins S02_ARESETN] [get_bd_pins S03_ARESETN] [get_bd_pins psr_aclk1/interconnect_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M00_AXI:S00_AXI:S02_AXI:S03_AXI} \
 ] $aclk1
