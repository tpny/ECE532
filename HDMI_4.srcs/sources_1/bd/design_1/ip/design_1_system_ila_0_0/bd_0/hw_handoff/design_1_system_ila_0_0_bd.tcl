...
proc create_root_design { parentCell } {
  ...
  set probe9 [ create_bd_port -dir I -from 10 -to 0 probe9 ]
  set probe10 [ create_bd_port -dir I -from 10 -to 0 probe10 ]
  set probe11 [ create_bd_port -dir I -from 0 -to 0 probe11 ]
  set probe12 [ create_bd_port -dir I -from 10 -to 0 probe12 ]
  set probe13 [ create_bd_port -dir I -from 10 -to 0 probe13 ]
  set probe14 [ create_bd_port -dir I -from 0 -to 0 probe14 ]
  set probe15 [ create_bd_port -dir I -from 10 -to 0 probe15 ]
  set probe16 [ create_bd_port -dir I -from 10 -to 0 probe16 ]
  set probe17 [ create_bd_port -dir I -from 0 -to 0 probe17 ]
  set probe18 [ create_bd_port -dir I -from 10 -to 0 probe18 ]
  set probe19 [ create_bd_port -dir I -from 10 -to 0 probe19 ]
  set probe20 [ create_bd_port -dir I -from 31 -to 0 probe20 ]
  set probe21 [ create_bd_port -dir I -from 0 -to 0 probe21 ]
  set probe22 [ create_bd_port -dir I -from 31 -to 0 probe22 ]
  set probe23 [ create_bd_port -dir I -from 31 -to 0 probe23 ]
  set probe24 [ create_bd_port -dir I -from 31 -to 0 probe24 ]
