...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock, reset & status pins of CMDA_controller_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins CMDA_controller_0/axi_lite]
	connect_bd_net [get_bd_pins CMDA_controller_0/axi_lite_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins CMDA_controller_0/axi_lite_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins CMDA_controller_0/axi_lite_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins CMDA_controller_0/axi_lite_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins CMDA_controller_0/axi_lite_init_axi_txn] [ get_bd_pins axi_gpio_out/gpio_io_o ]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of CMDA_controller_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {CMDA_controller_0/axi_lite/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_axi_lite_TARGET_SLAVE_BASE_ADDR {0xC0000000} ] [get_bd_cells CMDA_controller_0]

	# Copy all address to CMDA_controller_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/CMDA_controller_v1_0_include.tcl"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/CMDA_controller_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "CMDA_controller_v1_0_hw_${i}"
