# Runtime Tcl commands to interact with - CMDA_controller_v1_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/CMDA_controller_v1_0_include.tcl
...
# Test: axi_lite
set wdata_axi_lite [get_init_data 0]
create_hw_axi_txn w_axi_lite_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_axi_lite}
create_hw_axi_txn r_axi_lite_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
...
if { $DE == 01 } {
	...
	puts "Data comparison test fail for - axi_lite, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}
